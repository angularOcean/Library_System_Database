...
CREATE TABLE Books(
    ...
    SET NULL,
        FOREIGN KEY (publisher_id) REFERENCES Publishers(publisher_id) ON DELETE
    SET NULL
);
/*
 Authors 
...
CREATE TABLE CheckedBooks(
    ...
    FOREIGN KEY (checkout_id) REFERENCES Checkouts(checkout_id) ON DELETE
    SET NULL ON UPDATE CASCADE,
        FOREIGN KEY (copy_id) REFERENCES BookCopies(copy_id) ON DELETE
    SET NULL ON UPDATE CASCADE
);
/*
 ---DATA---
...
VALUES ('Little Penguin Library', '67 Cooper Ave'),
    ...
    (
        ...
        '309 East Walnutwood Lane'
    );
/*
 Patrons 
 */
INSERT INTO Patrons(patron_first, patron_last, email)
VALUES ('Koko', 'Irish', 'kokoiri@egl.com'),
...
/*
 Books
 */
INSERT INTO Books(isbn, title, author_id, year, publisher_id)
VALUES ('978-19-8213798-4', 'If It Bleeds', 1, '2021', 1),
    (
        '978-15-0114741-8',
        'Needful Things',
        1,
...
/*
 Checkouts
 */
INSERT INTO Checkouts(patron_id, checkout_date, return_date)
VALUES (4, '2022-02-03', '2022-02-24'),
