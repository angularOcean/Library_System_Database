 ...
 */
        ...
        (
            patron_id INT UNIQUE NOT NULL
            AUTO_INCREMENT,
    patron_first VARCHAR
            (255) NOT NULL,
    patron_last VARCHAR
            (255) NOT NULL,
    email VARCHAR
 ...
 */
            ...
            (
                publisher_id INT UNIQUE NOT NULL
                AUTO_INCREMENT,
 ...
 */
                        ...
                        (
                            checked_book_id INT UNIQUE NOT NULL
                            AUTO_INCREMENT,
    checkout_id INT,
    copy_id INT,
    returned TINYINT
    ...
    PRIMARY KEY
                            (checked_book_id),
    FOREIGN KEY
                            (checkout_id) REFERENCES Checkouts
                            (checkout_id) ON
                            DELETE
                            SET NULL
                            ON
 ...
 */
                            INSERT INTO Patrons
                                (patron_first, patron_last, email)
                            VALUES
 ...
 */
                            INSERT INTO Books
                                (isbn, title, author_id, year, publisher_id)
                            VALUES
